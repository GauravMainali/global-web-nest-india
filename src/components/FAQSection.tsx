    ...
    <section className="relative overflow-hidden py-32">
      ...
      <div className="section-container relative z-10">
        ...
        <motion.div
          ...
          className="mx-auto max-w-3xl relative z-20"
        >
          <Accordion type="single" collapsible className="space-y-4">
            {faqs.map((faq, index) => (
              ...
              >
                <AccordionItem
                  value={`item-${index}`}
                  className="glass-card rounded-2xl border border-border/50 px-6 data-[state=open]:border-foreground/20 relative overflow-hidden"
                >
                  <AccordionTrigger className="relative z-40 py-6 text-left text-lg font-semibold text-foreground hover:no-underline [&[data-state=open]>svg]:rotate-180">
                    {faq.question}
                  </AccordionTrigger>
                  <AccordionContent className="relative z-30 pb-6 text-muted-foreground leading-relaxed">
                    {faq.answer}
                  </AccordionContent>
                </AccordionItem>
              </motion.div>
