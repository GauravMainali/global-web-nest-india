          ...
          <div className="section-container relative z-10">
            ...
            >
              ...
              <h1 className="mb-6 text-5xl font-bold text-foreground sm:text-6xl lg:text-7xl">
                Visual <span className="text-gradient">Sorcery</span>
              </h1>
              <p className="mb-10 text-xl text-muted-foreground">
                We transmute abstract concepts into tangible visual gold.
                Identities that don't just exist, but resonate on a frequency of pure excellence.
              </p>
              <Link to="/contact">
                <Button
                  size="lg"
