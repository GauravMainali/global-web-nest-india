...
import { ArrowRight, Video, Film, Clapperboard, PlayCircle, Wand2, Volume2 } from "lucide-react";

const benefits = [
  { icon: Video, text: "Commercial video production" },
  { icon: Film, text: "Social media content" },
  { icon: Clapperboard, text: "Brand storytelling" },
  { icon: PlayCircle, text: "Explainer videos" },
  { icon: Wand2, text: "Motion graphics & VFX" },
  { icon: Volume2, text: "Sound design & mixing" },
];
          ...
          <div className="section-container relative z-10">
            ...
            >
              ...
              <h1 className="mb-6 text-5xl font-bold text-foreground sm:text-6xl lg:text-7xl">
                Cinematic <span className="text-gradient">Narrative</span>
              </h1>
              <p className="mb-10 text-xl text-muted-foreground">
                Frame-by-frame perfection. We craft visual symphonies that echo in the viewer's mind long after the screen goes dark.
              </p>
              <Link to="/contact">
                <Button
                  size="lg"
