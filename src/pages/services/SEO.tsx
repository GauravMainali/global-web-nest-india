          ...
          <div className="section-container relative z-10">
            ...
            >
              ...
              <h1 className="mb-6 text-5xl font-bold text-foreground sm:text-6xl lg:text-7xl">
                Search <span className="text-gradient">Supremacy</span>
              </h1>
              <p className="mb-10 text-xl text-muted-foreground">
                We don't just chase algorithms; we predict them.
                Claim your rightful place at the digital summit with authoritative SEO strategies.
              </p>
              <Link to="/contact">
                <Button
                  size="lg"
