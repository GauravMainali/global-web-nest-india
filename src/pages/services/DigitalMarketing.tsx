          ...
          <div className="section-container relative z-10">
            ...
            >
              ...
              <h1 className="mb-6 text-5xl font-bold text-foreground sm:text-6xl lg:text-7xl">
                Algorithmic <span className="text-gradient">Dominance</span>
              </h1>
              <p className="mb-10 text-xl text-muted-foreground">
                We don't just run ads; we engineer market takeovers.
                Data-driven campaigns that penetrate noise and capture intent at scale.
              </p>
              <Link to="/contact">
                <Button
                  size="lg"
