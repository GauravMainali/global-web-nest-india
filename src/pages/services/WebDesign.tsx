...
const benefits = [
  { icon: Palette, text: "Bespoke Aesthetics & Brand Narrative" },
  { icon: Zap, text: "Ultra-Low Latency & High Performance" },
  { icon: Shield, text: "Fortified Security Architecture" },
  { icon: TrendingUp, text: "Behavioral Science-Backed Conversion" },
  { icon: Code, text: "Scalable, Future-Proof React Codebase" },
  { icon: Smartphone, text: "Fluid Responsiveness Across All Devices" },
];
          ...
          <div className="section-container relative z-10">
            ...
            >
              ...
              <h1 className="mb-6 text-5xl font-bold text-foreground sm:text-6xl lg:text-7xl">
                Beyond <span className="text-gradient">Pixels</span>
              </h1>
              <p className="mb-10 text-xl text-muted-foreground">
                We don't just build websites; we construct digital flagships.
                Experience the perfect synthesis of aesthetic purity and technical performance.
              </p>
              <Link to="/contact">
                <Button
                  size="lg"
              ...
              <div className="space-y-12">
                {process.map((item, index) => (
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    transition={{ duration: 0.6, delay: index * 0.1 }}
                    className={`relative flex items-center gap-8 lg:justify-center ${index % 2 === 0 ? "lg:flex-row" : "lg:flex-row-reverse"
                      }`}
                  >
                    <div className={`glass-card max-w-md rounded-2xl p-8 ${index % 2 === 0 ? "lg:text-right" : "lg:text-left"
                      }`}>
