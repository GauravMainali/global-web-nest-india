          ...
          <div className="section-container relative z-10">
            ...
            >
              ...
              <h1 className="mb-8 text-5xl font-bold tracking-tighter text-foreground sm:text-6xl lg:text-7xl">
                We Architect <br />
                <span className="text-gradient">Digital Dimensions</span>
              </h1>
              <p className="mx-auto max-w-2xl text-xl leading-relaxed text-muted-foreground">
                In a world of noise, we design silence. In a world of flat screens, we build depth.
                Web Nest India is a premium digital atelier crafting immersive 3D experiences for the brands of 2026.
              </p>
            </motion.div>
          </div>
        </section>
